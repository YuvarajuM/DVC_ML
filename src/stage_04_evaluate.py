...
def evaluate(config_path, params_path):
    ...
    scores_dir_path = os.path.join(artifacts_dir, scores_dir)# reports_dir/scores.json
    create_directory([scores_dir_path])

    scores_filepath = os.path.join(scores_dir_path, scores_filename)# reports_dir/scores.json
